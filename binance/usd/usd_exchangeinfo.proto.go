...
const UsdExchangeInfoMethod = "GET"

const UsdExchangeInfoUrl = "https://fapi.binance.com/fapi/v1/exchangeInfo"

type UsdExchangeInfoParam struct {
	binance.BaseParam
}

func (k UsdExchangeInfoParam) RequireAuth() bool {
	return true
}

func (k *UsdExchangeInfoParam) Prepare(ctx context.Context) (err error) {
	return
}

type UsdExchangeInfoResp struct {
	BaseResp
